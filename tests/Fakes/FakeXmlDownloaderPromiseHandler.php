...
/**
 * This implementation of XmlDownloaderPromiseHandlerInterface set
 ...
 *
 */
final class FakeXmlDownloaderPromiseHandler implements XmlDownloaderPromiseHandlerInterface
{
    /** @var string[] */
